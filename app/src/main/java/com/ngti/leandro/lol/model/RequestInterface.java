...
public interface RequestInterface {
    ...
    String AUTHORIZATION = "X-Riot-Token: RGAPI-4e73df6a-8364-48ca-a1e8-040f4829ae6e";

    String MATCH_LIST_BY_ACCOUNT_ID = "/lol/match/v3/matchlists/by-account/{accountId}?endIndex=10";
