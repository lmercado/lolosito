...
public class LoadChampionsRecentMatches extends AsyncTask<String, Integer, Champions> {
    ...
    LoadChampionsRecentMatches(RecentMatchesActivity recentMatchesActivity) {
